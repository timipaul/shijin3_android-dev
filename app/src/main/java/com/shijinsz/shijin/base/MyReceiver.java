...
import com.shijinsz.shijin.ui.home.WebViewActivity;
    ...
    public void onReceive(Context context, Intent intent) {
        try {
            ...
            if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
                ...
                String extra = bundle.getString(JPushInterface.EXTRA_EXTRA);
                Gson gson =new Gson();
                PushBean bean= gson.fromJson(extra,PushBean.class);
                if (bean.getAd_detail()!=null){
                    Intent intent1 =new Intent(context, VideoDetailActivity.class);
                    intent1.putExtra("id",bean.getAd_detail());
                ...
                if (bean.getH5()!=null){
                    ...
                    intent1.putExtra("url",bean.getH5());
                    intent1.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP );
                    context.startActivity(intent1);
                    return;
                }
                ...
                Log.w(TAG, "JPush服务连接状态发生改变");
                boolean connected = intent.getBooleanExtra(JPushInterface.EXTRA_CONNECTION_CHANGE, false);
            } else {
                Log.d(TAG, "未处理的Intent");
            }
        } catch (Exception e) {
