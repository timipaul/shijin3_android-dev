...
public class PointMessageActivity extends BaseActivity implements OnRefreshListener, OnLoadMoreListener {
    ...
    public void initView(View view) {
        ...
        int num=Integer.parseInt(ShareDataManager.getInstance().getPara(SharedPreferencesKey.KEY_point_number));
        ...
        ShareDataManager.getInstance().save(mContext,SharedPreferencesKey.KEY_point_number,"0");
    ...
    private void delete_messages() {
        ...
        Map map = new HashMap();
        map.put("mode","point");
//        map.put("message_ids",delete.toArray());
    ...
    public void getPoint(final String cursor1) {
        ...
        map.put("mode","person");
        map.put("size","10");
        YSBSdk.getService(OAuthService.class).point(map, new YRequestCallback<PointBean>() {
            @Override
