...
public class PointDetailActivity extends BaseActivity implements OnLoadMoreListener, OnRefreshListener {
    ...
    public void initView(View view) {
        ...
        setTitle(getString(R.string.point_detail_list));
        showTitleBackButton();
    ...
    private void getData() {
        ...
        map.put("size", "10");
        YSBSdk.getService(OAuthService.class).point_detail(map, new YRequestCallback<BaseBean<PointDetailBean>>() {
            @Override
