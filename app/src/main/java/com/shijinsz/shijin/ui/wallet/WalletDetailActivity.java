...
public class WalletDetailActivity extends BaseActivity implements OnLoadMoreListener, OnRefreshListener {
    ...
    private void getData() {
        ...
        map.put("size", "10");
        YSBSdk.getService(OAuthService.class).change_detail(map, new YRequestCallback<BaseBean<PointDetailBean>>() {
            @Override
