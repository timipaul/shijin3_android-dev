...
import com.hongchuang.hclibrary.view.banner.listener.OnBannerClickListener;
import com.hongchuang.hclibrary.view.banner.listener.OnBannerListener;
import com.hongchuang.hclibrary.view.banner.loader.ImageLoaderInterface;
import com.hongchuang.hclibrary.view.banner.view.BannerViewPager;
...
//                Log.i(tag, "curr:" + currentItem + " count:" + count);
    ...
    public Banner(Context context, AttributeSet attrs, int defStyle) {
        ...
        indicatorSize = DevicesUtil.dip2px(getContext(), 2);
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorWidth = typedArray.getDimensionPixelSize(R.styleable.Banner_indicator_width, indicatorSize * 4);
