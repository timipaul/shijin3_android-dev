package com.hongchuang.hclibrary.view.menu;
...
public class SectorMenuButton extends View implements ValueAnimator.AnimatorUpdateListener {
    ...
    private static class MaskView extends View {
        private com.hongchuang.hclibrary.view.menu.SectorMenuButton SectorMenuButton;
        ...
        public MaskView(Context context, com.hongchuang.hclibrary.view.menu.SectorMenuButton button) {
            super(context);
