...
package com.hongchuang.ysblibrary.qrcode.camera;
...
final class FlashlightManager {
    ...
    static {
        ...
        setFlashEnabledMethod = getSetFlashEnabledMethod();
    ...
    private static Method getSetFlashEnabledMethod() {
        if (FlashlightManager.iHardwareService == null) {
            return null;
        }
        Class<?> proxyClass = FlashlightManager.iHardwareService.getClass();
    ...
    private static void setFlashlight() {
        if (iHardwareService != null) {
            invoke(setFlashEnabledMethod, iHardwareService, false);
        }
    }
