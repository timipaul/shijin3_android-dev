...
public class AmountView extends LinearLayout implements View.OnClickListener, TextWatcher, View.OnFocusChangeListener {
    ...
    public AmountView(Context context, AttributeSet attrs) {
        ...
        if (btnTextSize != 0) {
            ...
            btnDecrease.setTextColor(getResources().getColor(R.color.mine_function_divider));
            btnIncrease.setTextColor(getResources().getColor(R.color.mine_function_divider));
        }
...
//            setAmount(amount);
            etAmount.setText(amount + "");
            Log.d(TAG, "setMin_amount: "+etAmount.getText());
            Log.d(TAG, "setMin_amount: "+amount);
        }
    }
